    ...
    <div>
      <div className="m-[40px] rounded-custom2 flex flex-col py-[40px] px-[20px] w-[full] h-[full] bg-white border border-solid border-[#e3e5e7]">
        ...
        <div className="flex items-center ">
          <div
            className={`cursor-pointer text-sm font-normal font-['Work Sans'] leading-tight py-[10px] px-[20px] border-b-2 ${activeTab === 'campaign' ? 'text-sky-600 border-b-2 border-sky-600' : 'text-slate-800 border-b-2 border-gray-200'}`}
            onClick={() => handleTabClick('campaign')}
          >
            Campaign Analytics
          </div>
          <div
            className={`cursor-pointer  text-sm font-normal font-['Work Sans'] leading-tight py-[10px] px-[20px] border-b-2 ${activeTab === 'account' ? 'text-sky-600 border-b-2 border-sky-600' : 'text-slate-800 border-b-2 border-gray-200'}`}
          ...
          <div id="campaignanalytics">
            <div className="mr-[40px] flex flex-col">
              <div className=" overflow-x-auto sm:mx-6 lg:mx-8">
                <div id="campaignanalytics" className="py-2 mt-8 align-middle inline-block min-w-full sm:px-6 lg:px-8">

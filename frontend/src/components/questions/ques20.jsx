    ...
    return (
        <>
            <div class="w-[640px] h-[506px] p-[40px] mx-[40px] flex flex-col justify-start items-start bg-white rounded-2xl border border-zinc-200">
                ...
                <div class="w-[560px]  h-[52px]  text-slate-500 text-base font-normal font-['Work Sans'] leading-relaxed">Would you like to include published whitepapers or case studies in the search</div>

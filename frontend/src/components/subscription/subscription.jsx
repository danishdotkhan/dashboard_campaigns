const Subscription = () => {
    return(
        ...
        <div className="ml-[60px] mt-[24px] relative text-slate-800 text-2xl font-bold font-['Roboto']">Synapse.ai</div>
            
            <div className="flex w-full items-between flex-col justify-center relative  ">

                <div className="mx-[7%] mt-[40px] relative flex justify-center flex-col items-between">
                    <div class=" text-slate-800 text-xl font-bold font-['All Round Gothic'] leading-relaxed">Subscription</div>
                    <div class="w-[100%] h-[52px] text-slate-500 text-base font-normal font-['Work Sans'] leading-relaxed">Lorem ipsum dolor sit amet consectetur. Pretium felis commodo dignissim commodo risus vestibulum eu. Ac in massa id posuere risus faucibus.  Ac in id posuere risus faucibus.  </div>
                </div>

                <div className="flex w-full items-center justify-evenly relative mt-[32px]">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM16.0303 8.96967C16.3232 9.26256 16.3232 9.73744 16.0303 10.0303L11.0303 15.0303C10.7374 15.3232 10.2626 15.3232 9.96967 15.0303L7.96967 13.0303C7.67678 12.7374 7.67678 12.2626 7.96967 11.9697C8.26256 11.6768 8.73744 11.6768 9.03033 11.9697L10.5 13.4393L12.7348 11.2045L14.9697 8.96967C15.2626 8.67678 15.7374 8.67678 16.0303 8.96967Z" fill="#2A333F"/>
                </svg>

                            </div>
                        </div>
                        <div class="w-40 h-6 left-[20px] top-[314px] absolute">
                            <div class="left-[44px] top-[2px] absolute text-slate-800 text-base font-normal font-['Work Sans'] leading-snug">$0.245/profile</div>
                            <div class="w-6 h-6 left-0 top-0 absolute flex-col justify-start items-start inline-flex">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM16.0303 8.96967C16.3232 9.26256 16.3232 9.73744 16.0303 10.0303L11.0303 15.0303C10.7374 15.3232 10.2626 15.3232 9.96967 15.0303L7.96967 13.0303C7.67678 12.7374 7.67678 12.2626 7.96967 11.9697C8.26256 11.6768 8.73744 11.6768 9.03033 11.9697L10.5 13.4393L12.7348 11.2045L14.9697 8.96967C15.2626 8.67678 15.7374 8.67678 16.0303 8.96967Z" fill="#2A333F"/>
                </svg>
                        ...
                        <div class="w-32 h-6 left-[20px] top-[368px] absolute">
                            <div class="left-[44px] top-[2px] absolute text-slate-800 text-base font-normal font-['Work Sans'] leading-snug">3 revisions</div>
                            <div class="w-6 h-6 left-0 top-0 absolute flex-col justify-start items-start inline-flex">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM16.0303 8.96967C16.3232 9.26256 16.3232 9.73744 16.0303 10.0303L11.0303 15.0303C10.7374 15.3232 10.2626 15.3232 9.96967 15.0303L7.96967 13.0303C7.67678 12.7374 7.67678 12.2626 7.96967 11.9697C8.26256 11.6768 8.73744 11.6768 9.03033 11.9697L10.5 13.4393L12.7348 11.2045L14.9697 8.96967C15.2626 8.67678 15.7374 8.67678 16.0303 8.96967Z" fill="#2A333F"/>
                </svg>
                        ...
                        <div class="w-40 h-6 left-[20px] top-[422px] absolute">
                            <div class="left-[44px] top-[2px] absolute text-slate-800 text-base font-normal font-['Work Sans'] leading-snug">Email Support</div>
                            <div class="w-6 h-6 left-0 top-0 absolute flex-col justify-start items-start inline-flex">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM16.0303 8.96967C16.3232 9.26256 16.3232 9.73744 16.0303 10.0303L11.0303 15.0303C10.7374 15.3232 10.2626 15.3232 9.96967 15.0303L7.96967 13.0303C7.67678 12.7374 7.67678 12.2626 7.96967 11.9697C8.26256 11.6768 8.73744 11.6768 9.03033 11.9697L10.5 13.4393L12.7348 11.2045L14.9697 8.96967C15.2626 8.67678 15.7374 8.67678 16.0303 8.96967Z" fill="#2A333F"/>
                </svg>
                        ...
                        <div class="w-52 h-12 left-[20px] top-[522px] absolute rounded-lg cursor-pointer group ">
                            ...
                            <div class="left-[65.82px] top-[15px] absolute text-center text-white text-base font-medium font-['Work Sans']">Start Trial</div>
                        </div>
                    </div>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM16.0303 8.96967C16.3232 9.26256 16.3232 9.73744 16.0303 10.0303L11.0303 15.0303C10.7374 15.3232 10.2626 15.3232 9.96967 15.0303L7.96967 13.0303C7.67678 12.7374 7.67678 12.2626 7.96967 11.9697C8.26256 11.6768 8.73744 11.6768 9.03033 11.9697L10.5 13.4393L12.7348 11.2045L14.9697 8.96967C15.2626 8.67678 15.7374 8.67678 16.0303 8.96967Z" fill="#2A333F"/>
                        ...
                        <div class="w-52 h-12 left-[20px] top-[522px] absolute rounded-lg group cursor-pointer">
                            ...
                            <div class="left-[65.82px] top-[15px] absolute text-center text-white text-base font-medium font-['Work Sans']">Subscribe</div>
                        </div>
                    </div>
                    <div class="w-64 h-96 relative">
                        <div class="w-64 h-[590px] left-0 top-0 absolute bg-white rounded-2xl border border-zinc-200"></div>
